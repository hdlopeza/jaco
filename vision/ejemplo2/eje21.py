...
def find_text_boxes(pre, min_text_height_limit=MIN_TEXT_HEIGHT_LIMIT, max_text_height_limit=MAX_TEXT_HEIGHT_LIMIT):
...
def find_table_in_boxes(boxes, cell_threshold=CELL_THRESHOLD, min_columns=MIN_COLUMNS):
    rows = {}
    cols = {}
