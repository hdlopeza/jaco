...
ds_val = tf.data.TFRecordDataset('/data/invoices_val.tfrecord')
ds_train = tf.data.TFRecordDataset('/data/invoices_train.tfrecord')
ds_test = tf.data.TFRecordDataset('/data/invoices_test.tfrecord')

ds_val = ds_val.map(utils.parse_tfrecords)
ds_train = ds_train.map(utils.parse_tfrecords)
ds_test = ds_test.map(utils.parse_tfrecords)
